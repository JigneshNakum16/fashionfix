...
if (isset($_POST['order_btn'])) {
    ...
    if (mysqli_num_rows($cart_query) > 0) {
        while ($product_item = mysqli_fetch_assoc($cart_query)) {
            ...
            $product_price = $product_item['price'] * $product_item['qty']; // Calculate without number_format
    ...
    $clear_cart_query = mysqli_query($conn, "DELETE FROM `cart`") or die('query failed');
    if ($cart_query && $detail_query) {
       ...
       <div class='message-container'>
          ...
          <div class='customer-details'>
             ...
             <a href='ecom.php' class='btn'>continue shopping</a>
          </div>
       </div>
       ";
    }
        ...
        <section class="checkout-form">
            ...
            <form action="" method="post">
                ...
                <div class="display-order">
                    ...
                    if (mysqli_num_rows($select_cart) > 0) {
                        while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                            $total_price = $fetch_cart['price'] * $fetch_cart['qty']; // Calculate without number_format
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <span>city</span>
                        <input type="text" placeholder="e.g. Surat" name="city" required>
                    </div>
                    <div class="inputBox">
                        <span>state</span>
                        <input type="text" placeholder="e.g. Gujarat" name="state" required>
                    </div>
                    <div class="inputBox">
                        <span>country</span>
